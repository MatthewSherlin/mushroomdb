...
with tempfile.TemporaryDirectory() as db_path:
    ...
    docs = [
        ...
        Document(text="Bob works at Acme Corp."),
    ]
    ...
    nodes = retriever.retrieve("Who does Alice know?")
    for n in nodes:
        print(n.get_content())
```
...
|---|---|---|
| `upsert_nodes` | Yes | EntityNode and ChunkNode; idempotent |
...
| `structured_query` | Yes | Cypher passthrough to mushroomdb |
...
- **Cypher subset**: mushroomdb implements a subset of openCypher. `MERGE`, `id()`, and some functions are not available. Use `structured_query` accordingly.
